            ...
            try {
                while ((message = reader.readLine()) != null) {
                    ...
                    if (data[2].equals(connect)) {
                        ...
                        userAdd(data[0], client);
                    } else if (data[2].equals(disconnect)) {
                        tellEveryone((data[0] + " has disconnected." + " " + chat));
                        userRemove(data[0]);
                    } else if (data[2].equals(chat)) {
                        if (data[1].indexOf(":") != -1) {
                            tellOnePerson(data[0], data[1]);
                        }
...
//				clientOutputStreams.put(clientSock.getInetAddress().getHostAddress(), writer);
    ...
    public void userAdd(String data, PrintWriter clientSock) {
        clientOutputStreams.put(data, clientSock);
    ...
    public void tellOnePerson(String name, String message) {
        String[] mess = message.split("%");
        PrintWriter print = clientOutputStreams.get(mess[0]);
        print.println(name + ": " + mess[1]);
        print.flush();
    }
